---
description: Production readiness verify for orders
---

# Production Readiness: orders (platform/admin/orders.html)

This workflow defines the steps to verify that the `orders` page is fully production-ready.
