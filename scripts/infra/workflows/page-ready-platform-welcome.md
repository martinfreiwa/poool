---
description: Production readiness verify for welcome
---

# Production Readiness: welcome (platform/welcome.html)

This workflow defines the steps to verify that the `welcome` page is fully production-ready.
