---
description: Production readiness verify for email-marketing
---

# Production Readiness: email-marketing (platform/admin/email-marketing.html)

This workflow defines the steps to verify that the `email-marketing` page is fully production-ready.
