---
description: Production readiness verify for maintenance
---

# Production Readiness: maintenance (platform/maintenance.html)

This workflow defines the steps to verify that the `maintenance` page is fully production-ready.
