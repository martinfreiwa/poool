---
description: Production readiness verify for commodity
---

# Production Readiness: commodity (platform/commodity.html)

This workflow defines the steps to verify that the `commodity` page is fully production-ready.
