---
description: Production readiness verify for terms
---

# Production Readiness: terms (platform/terms.html)

This workflow defines the steps to verify that the `terms` page is fully production-ready.
