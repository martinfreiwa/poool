---
description: Production readiness verify for add-asset
---

# Production Readiness: add-asset (platform/developer/add-asset.html)

This workflow defines the steps to verify that the `add-asset` page is fully production-ready.
