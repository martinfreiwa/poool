---
description: Production readiness verify for reports
---

# Production Readiness: reports (platform/admin/reports.html)

This workflow defines the steps to verify that the `reports` page is fully production-ready.
