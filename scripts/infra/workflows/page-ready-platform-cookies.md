---
description: Production readiness verify for cookies
---

# Production Readiness: cookies (platform/cookies.html)

This workflow defines the steps to verify that the `cookies` page is fully production-ready.
