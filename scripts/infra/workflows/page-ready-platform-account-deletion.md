---
description: Production readiness verify for account-deletion
---

# Production Readiness: account-deletion (platform/account-deletion.html)

This workflow defines the steps to verify that the `account-deletion` page is fully production-ready.
