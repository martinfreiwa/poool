---
description: Production readiness verify for kyc
---

# Production Readiness: kyc (platform/admin/kyc.html)

This workflow defines the steps to verify that the `kyc` page is fully production-ready.
