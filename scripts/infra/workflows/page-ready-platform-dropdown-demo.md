---
description: Production readiness verify for dropdown-demo
---

# Production Readiness: dropdown-demo (platform/dropdown-demo.html)

This workflow defines the steps to verify that the `dropdown-demo` page is fully production-ready.
