---
description: Production readiness verify for 500
---

# Production Readiness: 500 (platform/500.html)

This workflow defines the steps to verify that the `500` page is fully production-ready.
