---
description: Production readiness verify for marketplace
---

# Production Readiness: marketplace (platform/marketplace.html)

This workflow defines the steps to verify that the `marketplace` page is fully production-ready.
