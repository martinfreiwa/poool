---
description: Production readiness verify for imprint
---

# Production Readiness: imprint (platform/imprint.html)

This workflow defines the steps to verify that the `imprint` page is fully production-ready.
