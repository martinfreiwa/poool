---
description: Production readiness verify for assets
---

# Production Readiness: assets (platform/developer/assets.html)

This workflow defines the steps to verify that the `assets` page is fully production-ready.
