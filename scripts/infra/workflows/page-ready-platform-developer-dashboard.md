---
description: Production readiness verify for dashboard
---

# Production Readiness: dashboard (platform/developer/dashboard.html)

This workflow defines the steps to verify that the `dashboard` page is fully production-ready.
