---
description: Production readiness verify for treasury
---

# Production Readiness: treasury (platform/admin/treasury.html)

This workflow defines the steps to verify that the `treasury` page is fully production-ready.
