---
description: Production readiness verify for gdpr-data-request
---

# Production Readiness: gdpr-data-request (platform/gdpr-data-request.html)

This workflow defines the steps to verify that the `gdpr-data-request` page is fully production-ready.
