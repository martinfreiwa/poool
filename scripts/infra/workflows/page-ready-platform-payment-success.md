---
description: Production readiness verify for payment-success
---

# Production Readiness: payment-success (platform/payment-success.html)

This workflow defines the steps to verify that the `payment-success` page is fully production-ready.
