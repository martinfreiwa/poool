---
description: Production readiness verify for checkout
---

# Production Readiness: checkout (platform/checkout.html)

This workflow defines the steps to verify that the `checkout` page is fully production-ready.
