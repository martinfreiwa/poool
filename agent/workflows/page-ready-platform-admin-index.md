---
description: Production readiness verify for index
---

# Production Readiness: index (platform/admin/index.html)

This workflow defines the steps to verify that the `index` page is fully production-ready.
