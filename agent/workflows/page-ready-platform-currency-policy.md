---
description: Production readiness verify for currency-policy
---

# Production Readiness: currency-policy (platform/currency-policy.html)

This workflow defines the steps to verify that the `currency-policy` page is fully production-ready.
