---
description: Production readiness verify for privacy-policy
---

# Production Readiness: privacy-policy (platform/privacy-policy.html)

This workflow defines the steps to verify that the `privacy-policy` page is fully production-ready.
