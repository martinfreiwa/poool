---
description: Production readiness verify for payment-in-progress
---

# Production Readiness: payment-in-progress (platform/payment-in-progress.html)

This workflow defines the steps to verify that the `payment-in-progress` page is fully production-ready.
