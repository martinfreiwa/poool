---
description: Production readiness verify for application-form
---

# Production Readiness: application-form (platform/developer/application-form.html)

This workflow defines the steps to verify that the `application-form` page is fully production-ready.
