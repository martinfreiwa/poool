---
description: Production readiness verify for forgot-password
---

# Production Readiness: forgot-password (platform/forgot-password.html)

This workflow defines the steps to verify that the `forgot-password` page is fully production-ready.
