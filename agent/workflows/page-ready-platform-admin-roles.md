---
description: Production readiness verify for roles
---

# Production Readiness: roles (platform/admin/roles.html)

This workflow defines the steps to verify that the `roles` page is fully production-ready.
