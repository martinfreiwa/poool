---
description: Production readiness verify for asset-details
---

# Production Readiness: asset-details (platform/admin/asset-details.html)

This workflow defines the steps to verify that the `asset-details` page is fully production-ready.
