---
description: Production readiness verify for 404
---

# Production Readiness: 404 (platform/404.html)

This workflow defines the steps to verify that the `404` page is fully production-ready.
