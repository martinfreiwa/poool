---
description: Production readiness verify for aml-kyc-policy
---

# Production Readiness: aml-kyc-policy (platform/aml-kyc-policy.html)

This workflow defines the steps to verify that the `aml-kyc-policy` page is fully production-ready.
