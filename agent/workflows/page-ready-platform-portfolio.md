---
description: Production readiness verify for portfolio
---

# Production Readiness: portfolio (platform/portfolio.html)

This workflow defines the steps to verify that the `portfolio` page is fully production-ready.
