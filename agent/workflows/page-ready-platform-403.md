---
description: Production readiness verify for 403
---

# Production Readiness: 403 (platform/403.html)

This workflow defines the steps to verify that the `403` page is fully production-ready.
