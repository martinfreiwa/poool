---
description: Production readiness verify for support
---

# Production Readiness: support (platform/admin/support.html)

This workflow defines the steps to verify that the `support` page is fully production-ready.
