---
description: Production readiness verify for storage
---

# Production Readiness: storage (platform/admin/storage.html)

This workflow defines the steps to verify that the `storage` page is fully production-ready.
