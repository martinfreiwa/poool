---
description: Production readiness verify for transactions
---

# Production Readiness: transactions (platform/transactions.html)

This workflow defines the steps to verify that the `transactions` page is fully production-ready.
