---
description: Production readiness verify for auth-2fa
---

# Production Readiness: auth-2fa (platform/auth-2fa.html)

This workflow defines the steps to verify that the `auth-2fa` page is fully production-ready.
