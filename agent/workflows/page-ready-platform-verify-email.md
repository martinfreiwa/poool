---
description: Production readiness verify for verify-email
---

# Production Readiness: verify-email (platform/verify-email.html)

This workflow defines the steps to verify that the `verify-email` page is fully production-ready.
