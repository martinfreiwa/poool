---
description: Production readiness verify for cart
---

# Production Readiness: cart (platform/cart.html)

This workflow defines the steps to verify that the `cart` page is fully production-ready.
