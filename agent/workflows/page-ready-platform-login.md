---
description: Production readiness verify for login
---

# Production Readiness: login (platform/login.html)

This workflow defines the steps to verify that the `login` page is fully production-ready.
