...
function renderSubmission(data) {
  ...
  // Editable property-page content + milestones (shared editor module)
  if (window.PropertyPageEditor && asset.id) {
    PropertyPageEditor.init({ assetId: asset.id, asset, milestones: milestones || [] });
  }
