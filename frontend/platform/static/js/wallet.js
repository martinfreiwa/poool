    ...
    function handleUrlParams() {
        ...
        if (params.has("deposit_completed")) {
            ...
            const errMap = {
                ...
                withdraw_2fa_required: "Two-factor authentication required. Open the Withdraw dialog to enter your code.",
                withdraw_new_account_cooldown: "Your account is in the post-verification cooldown window. Larger withdrawals unlock after 72 hours.",
                withdraw_daily_cap: "Daily withdrawal limit reached. Try again tomorrow or contact support.",
                withdraw_velocity_frozen: "Too many recent withdrawals. Your account is temporarily frozen — contact support to review.",
                in_progress: "An earlier request is still processing. Please wait a moment and try again.",
                sof_doc_required: "Please attach a supporting document for the source of these funds.",
                sof_doc_too_large: "Supporting document is too large. Max 10 MB.",
                sof_doc_read_failed: "Could not read the source-of-funds document. Try a different file.",
