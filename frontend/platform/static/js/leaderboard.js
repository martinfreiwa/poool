...
(function () {
  ...
  function getDemoData() {
    ...
    var sorted = DEMO_RANKINGS.slice().sort(function (a, b) {
    ...
    return {
      rankings: sorted,
      my_rank: { rank: null, metric_value: 0, metrics: { total_invested_cents: 0, asset_count: 0, portfolio_roi_bps: 0, affiliate_count: 0, referral_revenue_cents: 0, highest_investment_cents: 0 }},
