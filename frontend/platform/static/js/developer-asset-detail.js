...
function showToast(msg) {
  ...
  t.style.cssText =
    "position:fixed;bottom:24px;right:24px;z-index:9999;padding:12px 20px;border-radius:8px;font-size:13px;font-weight:500;background:var(--badge-success-color, #027A48);color:#fff;box-shadow:0 4px 20px rgba(0,0,0,0.2);animation:toastIn 0.25s ease;";
  t.textContent = msg;
