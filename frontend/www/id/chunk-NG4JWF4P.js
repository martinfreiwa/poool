...
var et = {
  ...
  ri = function (t) {
    var e = t[0],
      i,
      r;
    if ((lt(e) || L(e) || (t = [t]), !(i = (e._gsap || {}).harness))) {
      for (r = ge.length; r-- && !ge[r].targetTest(e); );
      i = ge[r];
    }
    for (r = t.length; r--; )
      (t[r] && (t[r]._gsap || (t[r]._gsap = new ai(t[r], i)))) ||
        t.splice(r, 1);
    return t;
  },
  bt = function (t) {
  ...
  ni = function (t, e, i) {
    return (i = t[e]) && L(i)
      ? t[e]()
      : (Pe(i) && t.getAttribute && t.getAttribute(e)) || i;
  },
  j = function (t, e) {
  ...
  Ui = function (t) {
    var e = parseFloat(t);
    return (e || e === 0) && (t + "").match(Fi).length < 2
      ? e
      : U(t)
        ? t.trim()
        : t;
  ...
  re = function (t) {
    var e = t.parent || z,
      i = t.keyframes ? Vr(K(t.keyframes)) : st;
    if (tt(t.inherit))
  ...
  qi = function (t, e) {
    ...
    if (
      ((e._time ||
        ...
        ((i = we(t.rawTime(), e)),
        (!e._dur || _e(0, e.totalDuration(), i) - e._tTime > M) &&
          e.render(i, !0)),
  ...
  ht = function (t, e, i, r) {
    return (
      ...
      Xi(t, e, "_first", "_last", t._sort ? "_start" : 0),
      qe(e) || (t._recent = e),
      r || qi(t, e),
  ...
  Gi = function (t, e) {
    return (
      (nt.ScrollTrigger || Se("scrollTrigger", e)) &&
  ...
  Gr = function (t, e, i, r) {
    ...
    if (
      ...
      if (!t._initted && Wi(t, e, r, i, o)) return;
      for (
        l = t._zTime,
          t._zTime = e || (i ? M : 0),
          i || (i = e && !l),
  ...
  Qr = { _start: 0, endTime: oe, totalDuration: oe },
  at = function u(t, e, i) {
    var r = t.labels,
      n = t._recent || Qr,
        ...
        o === "<" || o === ">"
          ...
          : a < 0
            ...
            : ((o = parseFloat(e.charAt(a - 1) + e.substr(a + 1))),
              f && i && (o = (o / 100) * (K(i) ? i[0] : i).totalDuration()),
  ...
  ut = function (t, e, i) {
    return E && !e && E.selector
      ? E.selector(t)
      : U(t) && !i && (Ue || !Qt())
        ? Ge.call((e || ti).querySelectorAll(t), 0)
        : K(t)
          ? Zr(t, i)
          : Qi(t)
            ? Ge.call(t, 0)
    ...
    return (
      ...
      function (c, d, p) {
        ...
        if (!m) {
          ...
          for (
            m = s[h] = [],
              y = o ? Math.min(w, h) * _ - 0.5 : r % w,
              x = w === ot ? 0 : o ? (h * l) / w - 0.5 : (r / w) | 0,
              P = 0,
              S = ot,
              b = 0;
            b < h;
            ...
            ((v = (b % w) - y),
              (T = x - ((b / w) | 0)),
              (m[b] = g = f ? Math.abs(f === "y" ? T : v) : Ei(v * v + T * T)),
              g > P && (P = g),
              g < S && (S = g));
          (r === "random" && Ki(m),
            (m.max = P - S),
  ...
  $i = function (t, e, i, r) {
    return St(K(t) ? !e : i === !0 ? !!(i = 0) : !r, function () {
      return K(t)
  ...
  Kt = function (t) {
    for (var e = 0, i = "", r, n, s, a; ~(r = t.indexOf("random(", e)); )
      ((s = t.indexOf(")", r)),
        (a = t.charAt(r + 7) === "["),
        (n = t.substr(r + 7, s - r - 7).match(a ? Fi : Ve)),
        (i +=
          t.substr(e, r - e) + $i(a ? n : +n[0], a ? 0 : +n[1], +n[2] || 1e-5)),
        (e = s + 1));
  ...
  ir = function (t, e, i) {
    ...
    if (!r) {
      ...
      } else r = t.match(Ve) || ie.transparent;
      r = r.map(Number);
    }
    return (
      e &&
  ...
  Di = function (t, e, i) {
    ...
    if (
      ...
      i && ((_ = rr(t)), (o = i.c), o.join(r) !== _.c.join(r)))
    )
    ...
    if (!f)
      for (f = t.split(gt), l = f.length - 1; a < l; a++) r += f[a] + n[a];
    return r + f[l];
  },
  gt = (function () {
    var u =
  ...
  J = (function () {
    ...
    return (
      (l = {
        ...
        wake: function () {
          Li &&
            (!Ue &&
              ...
              (ti = _t.document || {}),
              (nt.gsap = Z),
              (_t.gsapVersions || (_t.gsapVersions = [])).push(Z.version),
              Ii(xe || _t.GreenSockGlobals || (!_t.gsap && _t) || {}),
              tr.forEach(er)),
        ...
        sleep: function () {
          ((_ ? cancelAnimationFrame : clearTimeout)(o), (ue = 0), (f = oe));
        },
        ...
        add: function (m, y, x) {
          var v = y
            ...
            : m;
          return (l.remove(m), a[x ? "unshift" : "push"](v), Qt(), v);
        },
        remove: function (m, y) {
  ...
  un = function (t) {
    ...
    return i && e.length > 1 && i.config
      ? i.config.apply(
          null,
          ~t.indexOf("{") ? [an(e[1])] : on(t).split(",").map(Ui),
        )
      : O._CE && nn.test(t)
        ? O._CE("", t)
        : i;
  ...
  Fe = function u(t, e, i) {
    var r = e >= 1 ? e : 1,
      ...
      a = function (_) {
        return _ === 1 ? 1 : r * Math.pow(2, -10 * _) * Fr((_ - s) * n) + 1;
      },
      o =
        t === "out"
          ? a
    ...
    return (
      ...
      (t.totalTime = function (i, r) {
        ...
        return (
          (this._tTime !== i ||
            ...
            (this._ts || (this._pTime = i), Vi(this, i, r)),
          this
        );
      }),
      (t.time = function (i, r) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), i + ki(this)) %
      ...
      (t.timeScale = function (i, r) {
        ...
        return (
          ...
          this.totalTime(_e(-Math.abs(this._delay), this._tDur, n), r !== !1),
          ke(this),
          Yr(this)
        );
      }),
      ...
      (t.repeat = function (i) {
        return arguments.length
          ? ((this._repeat = i === 1 / 0 ? -2 : i), Ci(this))
          : this._repeat === -2
            ? 1 / 0
            : this._repeat;
      }),
...
var G = (function (u) {
  ...
  function t(i, r) {
    ...
    return (
      ...
      z && ht(i.parent || z, mt(n), r),
      i.reversed && n.reverse(),
      i.paused && n.paused(!0),
      i.scrollTrigger && Gi(mt(n), i.scrollTrigger),
      n
    );
  }
  var e = t.prototype;
  return (
    ...
    (e.staggerTo = function (r, n, s, a, o, f, _) {
      return (
        (s.duration = n),
    ...
    (e.staggerFrom = function (r, n, s, a, o, f, _) {
      return (
        (s.runBackwards = 1),
        (re(s).immediateRender = tt(s.immediateRender)),
        this.staggerTo(r, n, s, a, o, f, _)
      );
    }),
    (e.staggerFromTo = function (r, n, s, a, o, f, _, l) {
      return (
        (a.startAt = s),
        (re(a).immediateRender = tt(a.immediateRender)),
        this.staggerTo(r, n, a, o, f, _, l)
      );
    }),
    (e.render = function (r, n, s) {
      var a = this._time,
        ...
        P;
      if (
        (this !== z && _ > o && r >= 0 && (_ = o), _ !== this._tTime || s || l)
      ) {
        if (
          (a !== this._time &&
            f &&
          ...
          if (
            ...
            if (
              ...
              (a = S ? 0 : _ % f ? f : _),
              (this._lock = 1),
              (this.render(a || (P ? 0 : V(h * m)), n, !f)._lock = 0),
              (this._tTime = _),
        ...
        if (
          (this._hasPause &&
            !this._forcing &&
            this._lock < 2 &&
            ((x = Wr(this, V(a), V(c))), x && (_ -= c - (c = x._start))),
          (this._tTime = _),
          (this._time = c),
          (this._act = !v),
          this._initted ||
            ...
            (this._zTime = r),
            (a = 0)),
          !a && c && !n && !h && (rt(this, "onStart"), this._tTime !== _))
        )
          return this;
        if (c >= a && r >= 0)
          for (d = this._first; d; ) {
    ...
    (e.getTweensOf = function (r, n) {
      for (var s = [], a = ut(r), o = this._first, f = yt(n), _; o; )
        (o instanceof N
          ? Br(o._targets, a) &&
            (f
              ? (!Tt || (o._initted && o._ts)) &&
    ...
    (e.nextLabel = function (r) {
      return (r === void 0 && (r = this._time), Mi(this, at(this, r)));
    }),
    (e.previousLabel = function (r) {
      return (r === void 0 && (r = this._time), Mi(this, at(this, r), 1));
    }),
        ...
        for (l = s.parent; a; )
          ((f = a._prev),
            ...
            _ > o && s._sort && a._ts && !s._lock
              ? ((s._lock = 1), (ht(s, a, _ - a._delay, 1)._lock = 0))
              : (o = _),
            _ < 0 &&
              a._ts &&
              ((n -= _),
    ...
    (t.updateRoot = function (r) {
      if ((z._ts && (Vi(z, we(r, z)), (Bi = J.frame)), J.frame >= Si)) {
        Si += et.autoSleep || 120;
        var n = z._first;
...
st(G.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
var fn = function (t, e, i, r, n, s, a) {
    var o = new $(this._pt, t, e, 0, 1, hi, null, n),
      f = 0,
      _ = 0,
      l,
      c,
    ...
    for (
      o.b = i,
        ...
        i += "",
        r += "",
        (y = ~r.indexOf("random(")) && (r = Kt(r)),
        s && ((x = [i, r]), s(x, t, e), (i = x[0]), (r = x[1])),
        c = i.match(Re) || [];
      (l = Re.exec(r));
    )
      ((p = l[0]),
        (h = r.substring(f, l.index)),
  ...
  oi = function (t, e, i, r, n, s, a, o, f, _) {
    L(r) && (r = r(n || 0, t, s));
    var l = t[e],
      c =
        i !== "get"
    ...
    if (
      ...
      return !isNaN(c * r) && r !== ""
        ? ((p = new $(
          ...
          (this._pt = p))
        : (!l && !(e in t) && Se(e, r),
          fn.call(this, t, e, c, r, d, o || et.stringFilter, f));
  },
  _n = function (t, e, i, r, n) {
    if (
      (L(t) && (t = se(t, n, e, i, r)),
      !lt(t) || (t.style && t.nodeType) || K(t) || zi(t))
    )
  ...
  Ke,
    ...
    if (
      (T && (!c || !n) && (n = "none"),
      (t._ease = Rt(n, Xt.ease)),
      (t._yEase = l ? nr(Rt(l === !0 ? n : l, Xt.ease)) : 0),
      l &&
        t._yoyo &&
        !t._repeat &&
      ...
      if (
        ((D = m[0] ? bt(m[0]).harness : 0),
        (B = D && r[D.prop]),
        (g = Te(r, ei)),
        h &&
          (h._zTime < 0 && h.progress(1),
          e < 0 && _ && a && !d ? h.render(-1, !0) : h.revert(_ && p ? me : Ir),
          (h._lazy = 0)),
        s)
      ) {
        if (
      ...
      for (
        t._pt = t._ptCache = 0, o = (p && tt(o)) || (o && !p), b = 0;
        b < m.length;
        b++
      ) {
        if (
          ((w = m[b]),
          (R = w._gsap || ri(m)[b]._gsap),
          (t._ptLookup[b] = q = {}),
          Ye[R.id] && wt.length && ve(),
          (Y = x === m ? b : x.indexOf(w)),
          D &&
            (A = new D()).init(w, B || g, t, Y, x) !== !1 &&
            ((t._pt = S =
              new $(t._pt, w, A.name, 0, 1, A.render, A, 0, A.priority)),
            A._props.forEach(function (ft) {
              q[ft] = S;
            }),
            A.priority && (k = 1)),
          !D || B)
          ...
          for (P in g)
            H[P] && (A = ui(P, g, t, Y, w, x))
              ? A.priority && (k = 1)
              : (q[P] = S =
                  oi.call(t, w, P, "get", g[P], Y, x, 0, r.stringFilter));
  ...
  or = ii + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",
  ur = {};
j(or + ",id,stagger,delay,duration,paused,scrollTrigger", function (u) {
  return (ur[u] = 1);
});
var N = (function (u) {
  Ri(t, u);
  function t(i, r, n, s) {
    ...
    var o = a.vars,
      ...
      y = o.yoyoEase,
      x = r.parent || z,
      v = (K(i) || zi(i) ? yt(i[0]) : "length" in r) ? [i] : ut(i),
      T,
      g,
      b,
      P,
    ...
    if (
      ...
      if (
        ...
        if (((P = v.length), (k = c && Zi(c)), lt(c)))
          for (S in c) ~or.indexOf(S) && (R || (R = {}), (R[S] = c[S]));
        for (g = 0; g < P; g++)
          ((b = Te(r, ur)),
            (b.stagger = 0),
            y && (b.yoyoEase = y),
            ...
            (b.delay = (+se(_, mt(a), g, w, v) || 0) - a._delay),
            !c &&
              P === 1 &&
              b.delay &&
              ((a._delay = _ = b.delay), (a._start += _), (b.delay = 0)),
            T.to(w, b, k ? k(g, w, v) : 0),
            (T._ease = O.none));
        T.duration() ? (f = _ = 0) : (a.timeline = 0);
      } else if (p) {
        ...
        if (K(p))
          ...
          b = {};
          for (S in p)
            S === "ease" || S === "easeEach" || cn(S, p[S], b, p.easeEach);
          for (S in b)
            for (
              A = b[S].sort(function (B, X) {
                return B.t - X.t;
              }),
                D = 0,
                g = 0;
    ...
    return (
      d === !0 && !je && ((Tt = mt(a)), z.killTweensOf(v), (Tt = 0)),
      ht(x, mt(a), n),
  ...
  return (
    (e.render = function (r, n, s) {
      ...
      if (!f) Gr(this, r, n, s);
        ...
        if (!this._initted) {
          if (Wi(this, _ ? r : c, s, n, l)) return ((this._tTime = 0), this);
        ...
        ((v && v.render(r < 0 ? r : v._dur * v._ease(c / this._dur), n, s)) ||
          ...
          this._onUpdate &&
            !n &&
            (_ && Xe(this, r, n, s), rt(this, "onUpdate")),
          this._repeat &&
            p !== m &&
            this.vars.onRepeat &&
            !n &&
          ...
          (l === this._tDur || !l) &&
            this._tTime === l &&
            (_ && !this._onUpdate && Xe(this, r, !0, !0),
            (r || !f) &&
    ...
    (e.resetTo = function (r, n, s, a, o) {
      ...
      return (
        ...
        (_ = this._ease(f / this._dur)),
        hn(this, r, n, s, a, _, f, o)
      ...
      for (
        ...
        if (~o.indexOf(a[y])) {
          ...
          for (h in p)
            ((m = c && c[h]),
              m &&
                ((!("kill" in m.d) || m.d.kill(h) === !0) && Oe(this, m, "_pt"),
                delete c[h]),
              d !== "all" && (d[h] = 1));
        }
      return (this._initted && !this._pt && _ && ee(this), this);
    }),
    (t.to = function (r, n) {
...
var _i = function (t, e, i) {
  ...
  Me = function (t, e) {
    return L(t[e]) ? fr : Pe(t[e]) && t.setAttribute ? pn : _i;
  },
  _r = function (t, e) {
...
nt.TimelineLite = nt.TimelineMax = G;
z = new G({
  sortChildren: !1,
  defaults: Xt,
            ...
            ? (function () {
                for (var a = n.getTweens(), o = n.data.length, f; o--; )
                  ((f = n.data[o]),
                    f.data === "isFlip" &&
                      (f.revert(),
                      f.getChildren(!0, !0, !1).forEach(function (_) {
      ...
      (t.add = function (i, r, n) {
        ...
        for (f in i)
          f === "all"
            ...
            : ((o = _t.matchMedia(i[f])),
              o &&
                (Et.indexOf(s) < 0 && Et.push(s),
                (a[f] = o.matches) && (_ = 1),
                o.addListener
                  ? o.addListener(Ze)
                  : o.addEventListener("change", Ze)));
        return (
          _ &&
            r(s, function (l) {
              return s.add(null, l);
  ...
  be = {
    ...
    getProperty: function (t, e, i, r) {
      ...
      return (
        ...
        t &&
          (e
            ? s(((H[e] && H[e].get) || n)(t, e, i, r))
            : function (a, o, f) {
                return s(((H[a] && H[a].get) || n)(t, a, o, f));
              })
      );
    },
    ...
    defaults: function (t) {
      return (t && t.ease && (t.ease = Rt(t.ease, Xt.ease)), Oi(Xt, t || {}));
    },
    config: function (t) {
      return Oi(et, t || {});
    },
    registerEffect: function (t) {
      ...
      ((r || "").split(",").forEach(function (a) {
        return (
          a && !H[a] && !nt[a] && ae(e + " effect requires " + a + " plugin.")
        );
      }),
        (Ee[e] = function (a, o, f) {
        ...
        s &&
          (G.prototype[e] = function (a, o, f) {
            return this.add(Ee[e](a, lt(o) ? o : (f = o) && {}, this), f);
          }));
    },
...
N.version = G.version = Z.version = "3.12.7";
Li = 1;
$e() && Qt();
var Sn = O.Power0,
  On = O.Power1,
...
var lr,
    ...
    if (t in vt && n) {
      if (((this.tfm = this.tfm || {}), t !== "transform"))
        ((t = ct[t] || t),
          ...
          t === it && (this.tfm.zOrigin = s.zOrigin));
      else
      ...
      (e in vt && e !== it && (e = F),
        i.removeProperty
          ? ((r = e.substr(0, 2)),
            ...
            i.removeProperty(
              r === "--" ? e : e.replace(Ti, "-$1").toLowerCase(),
            ))
          : i.removeAttribute(e));
    }
  },
  kt = function (t, e, i, r, n, s) {
    var a = new $(t._pt, e, i, 0, 1, s ? br : wr);
  ...
  Ct = function u(t, e, i, r) {
    var n = parseFloat(i) || 0,
      ...
      _ = (f ? "client" : "offset") + (o ? "Width" : "Height"),
      l = 100,
      c = r === "px",
      d = r === "%",
      p,
    ...
    if (
      ...
      return (
        (p = y ? t.getBBox()[o ? "width" : "height"] : t[_]),
        I(d ? (n / p) * l : (n / 100) * p)
      );
    if (
      ...
      (m = h._gsap),
      m && d && m.width && o && m.time === J.time && !m.uncache)
    )
      return I((n / m.width) * l);
    if (d && (e === "height" || e === "width")) {
      var x = t.style[e];
      ((t.style[e] = l + r), (p = t[_]), x ? (t.style[e] = x) : Ut(t, e));
    } else
      ((d || s === "%") &&
        !ns[dt(h, "display")] &&
        ...
        (a.position = "absolute"));
    return (
      o && d && ((m = bt(h)), (m.time = J.time), (m.width = h[_])),
  ...
  ss = function (t, e, i, r) {
    ...
    var a = new $(this._pt, t.style, e, 0, 1, hi),
      o = 0,
      f = 0,
      _,
      l,
    ...
    } else a.r = e === "display" && r === "none" ? br : wr;
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if (n === "all" || n === !0) ((r.cssText = ""), (o = 1));
        ...
        for (n = n.split(","), f = n.length; --f > -1; )
          ((a = n[f]),
            vt[a] && ((o = 1), (a = a === "transformOrigin" ? it : F)),
            Ut(i, a));
      o &&
        (Ut(i, F),
        s &&
  ...
  vr = function (t) {
    var e = dt(t, F);
    return Dr(e) ? le : e.substr(7).match(He).map(I);
  },
  wi = function (t, e) {
    var i = t._gsap || bt(t),
      r = t.style,
    ...
    return i.svg && t.getAttribute("transform")
      ...
      : (n === le &&
          ...
          (!s || (!t.offsetParent && !t.getBoundingClientRect().width)) &&
            ((f = 1), (a = t.nextElementSibling), jt.appendChild(t)),
          (n = vr(t)),
          o ? (r.display = o) : Ut(t, "display"),
          f &&
            (a
              ? s.insertBefore(t, a)
              : s
  ...
  ce = function (t, e) {
    ...
    return (
      ...
      i.svg &&
        ...
        yi(t, X || f, !!X || i.originIsAbsolute, i.smooth !== !1, P)),
      (g = i.xOrigin || 0),
      (b = i.yOrigin || 0),
      P !== le &&
        ((R = P[0]),
        ...
        P.length === 6
          ? ((d = Math.sqrt(R * R + D * D)),
            ...
            (h = R || D ? Zt(D, R) * Bt : 0),
            (x = A || q ? Zt(A, q) * Bt + h : 0),
            x && (p *= Math.abs(Math.cos(x * $t))),
            i.svg && ((_ -= g - (g * R + b * A)), (l -= b - (g * D + b * q))))
          : ((Dt = P[6]),
            (Pi = P[7]),
            (Jt = P[8]),
            (te = P[9]),
            ...
            (p = I(Math.sqrt(B * B + Dt * Dt))),
            (S = Zt(Y, B)),
            (x = Math.abs(S) > 2e-4 ? S * Bt : 0),
            (T = pt ? 1 / (pt < 0 ? -pt : pt) : 0)),
        i.svg &&
          ((X = t.getAttribute("transform")),
          (i.forceCSS = t.setAttribute("transform", "") || !Dr(dt(t, F))),
      ...
      (i.renderTransform = i.svg ? fs : Or ? Ar : us),
      (i.uncache = 0),
      i
    );
  },
  ...
  Ar = function (t, e) {
    ...
    if (v && (l !== It || _ !== It)) {
      ...
      ((b = parseFloat(l) * $t),
        (w = Math.cos(b)),
        (s = di(x, s, P * w * -v)),
        (a = di(x, a, -Math.sin(b) * -v)),
        (o = di(x, o, S * w * -v + v)));
    }
    (m !== he && (T += "perspective(" + m + Nt),
      (r || n) && (T += "translate(" + r + "%, " + n + "%) "),
      (g || s !== he || a !== he || o !== he) &&
        (T +=
          o !== he || g
      ...
      _ !== It && (T += "rotateY(" + _ + Nt),
      l !== It && (T += "rotateX(" + l + Nt),
      (c !== It || d !== It) && (T += "skew(" + c + ", " + d + Nt),
      (p !== 1 || h !== 1) && (T += "scale(" + p + ", " + h + Nt),
  ...
  _s = function (t, e, i, r, n) {
    var s = 360,
      a = U(n),
      o = parseFloat(n) * (a && ~n.indexOf("rad") ? Bt : 1),
      f = o - r,
      _ = r + f + "deg",
      l,
      c;
    return (
      a &&
        ...
        l === "cw" && f < 0
          ? (f = ((f + s * dr) % s) - ~~(f / s) * s)
          : l === "ccw" && f > 0 && (f = ((f - s * dr) % s) - ~~(f / s) * s)),
      (t._pt = c = new $(t._pt, e, i, r, f, Qn)),
      (c.e = _),
      (c.u = "deg"),
      t._props.push(i),
      c
...
j("padding,margin,Width,Radius", function (u, t) {
  ...
  De[t > 1 ? "border" + u : u] = function (a, o, f, _, l) {
    var c, d;
...
var bi = {
    ...
    for (h in e)
      if (h !== "autoRound" && ((_ = e[h]), !(H[h] && ui(h, e, i, r, t, n)))) {
        if (
          ...
          d === "string" && ~_.indexOf("random(") && (_ = Kt(_)),
          p)
        )
          p(this, t, h, _, i) && (P = 1);
          ...
          ((f = (getComputedStyle(t).getPropertyValue(h) + "").trim()),
            (_ += ""),
            (gt.lastIndex = 0),
            gt.test(f) || ((m = Q(f)), (y = Q(_))),
            y ? m !== y && (f = Ct(t, h, f, y) + y) : m && (_ += m),
            this.add(a, "setProperty", f, _, r, n, 0, 0, h),
            s.push(h),
            S.push(h, 0, a[h]));
        else if (d !== "undefined") {
          if (
            (o && h in o
              ? ((f = typeof o[h] == "function" ? o[h].call(i, r, t, n) : o[h]),
                U(f) && ~f.indexOf("random(") && (f = Kt(f)),
                Q(f + "") ||
                  f === "auto" ||
                  (f += et.units[h] || Q(xt(t, h)) || ""),
                (f + "").charAt(1) === "=" && (f = xt(t, h)))
              : (f = xt(t, h)),
            (c = parseFloat(f)),
            (x = d === "string" && _.charAt(1) === "=" && _.substr(0, 2)),
            x && (_ = _.substr(2)),
            (l = parseFloat(_)),
            h in ct &&
              (h === "autoAlpha" &&
            ...
            if (
              ...
              T ||
                ...
                (T = this._pt =
                  new $(this._pt, a, F, 0, 1, g.renderTransform, g, 0, -1)),
                (T.dep = 1)),
              h === "scale")
            )
              ((this._pt = new $(
                ...
                "scaleY",
                g.scaleY,
                (x ? Ft(g.scaleY, x + l) : l) - g.scaleY || 0,
                pi,
              )),
                (this._pt.u = 0),
                s.push("scaleY", h),
              ...
              (S.push(it, 0, a[it]),
                ...
                g.svg
                  ? yi(t, _, 0, b, 0, this)
                  : ((y = parseFloat(_.split(" ")[2]) || 0),
                    y !== g.zOrigin && kt(this, g, "zOrigin", g.zOrigin, y),
                    kt(this, a, h, Ae(f), Ae(_))));
              continue;
            } else if (h === "svgOrigin") {
              yi(t, _, 1, b, 0, this);
              continue;
            } else if (h in Mr) {
              _s(this, g, h, c, x ? Ft(c, x + _) : _);
              continue;
          ...
          } else h in a || (h = Ht(h) || h);
          if (v || ((l || l === 0) && (c || c === 0) && !Wn.test(_) && h in a))
            ((m = (f + "").substr((c + "").length)),
              l || (l = 0),
              (y = Q(_) || (h in et.units ? et.units[h] : m)),
              m !== y && (c = Ct(t, h, f, y)),
              (this._pt = new $(
                this._pt,
                v ? g : a,
              ...
              (this._pt.u = y || 0),
              m !== y && y !== "%" && ((this._pt.b = f), (this._pt.r = Kn)));
          else if (h in a) ss.call(this, t, h, f, x ? x + _ : _);
          else if (h in t) this.add(t, h, f || t[h], x ? x + _ : _, r, n);
  ...
  getSetter: function (t, e, i) {
    ...
    return (
      r && r.indexOf(",") < 0 && (e = r),
      e in vt && e !== it && (t._gsap.x || xt(t, "x"))
        ? i && cr === i
          ? e === "scale"
            ? Jn
            : Hn
          : (cr = i || {}) && (e === "scale" ? ts : es)
        : t.style && !Pe(t.style[e])
          ? jn
          : ~e.indexOf("-")
            ? $n
            : Me(t, e)
  ...
  core: { _removeProperty: Ut, _getMatrix: wi },
};
