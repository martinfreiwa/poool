...
- Tracker report: `docs/PAGE_REVIEW_TRACKER.md`
...
10. `docs/page-review-tracker.yml`
11. `docs/automation-prompts/PRODUCTION_READINESS_STANDARDS.md`

If `docs/DESIGN.md` exists, read it too. If it does not exist, use `docs/FRONTEND_COMPONENTS.md`, `docs/brand/`, and existing frontend implementation as the design reference.
...
1. Read `docs/page-review-tracker.yml`.
...
10. Update `docs/page-review-tracker.yml`.
11. Regenerate `docs/PAGE_REVIEW_TRACKER.md`.
...
Update `docs/page-review-tracker.yml` according to its existing schema.
