...
def run_tests():
    ...
    for check, label in [
        ...
        ("settings-phone", "Phone display"),
        ("settings-dob", "Date of Birth input"),
        ("settings-nationality", "Nationality input"),
        ("settings-tax-id", "Tax ID input"),
        ("settings-address-1", "Address Line 1 input"),
        ("settings-address-2", "Address Line 2 input"),
        ("settings-city", "City input"),
