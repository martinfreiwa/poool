...
pub async fn api_admin_developer_project_detail(
    ...
    let row = sqlx::query(
        r#"SELECT
               ...
               -- Editable property-page content (migration 116, 117)
               a.investment_type,
               a.investment_type_description,
               a.leasing_strategy_type,
               a.leasing_strategy_description,
               a.risk_notification,
               a.default_investment_amount_cents,
               a.default_value_growth_bps,
               a.default_rental_yield_bps,
               a.developer_logo_url,
               a.developer_name,
               a.developer_description,
               a.developer_website,
               a.developer_facebook,
               a.developer_instagram,
               a.developer_youtube,
               a.info_badges,
               a.leasing_items,
               -- Developer
