    ...
    let articles: Vec<ArticleResponse> = rows
        ...
        .map(|r| ArticleResponse {
            ...
            author: AuthorSummary {
                ...
                avatar_url: r.get::<Option<String>, _>("author_avatar").map(|u| crate::storage::service::rewrite_gcs_url(&u)),
...
pub async fn list_authors(pool: &PgPool) -> Result<Vec<AuthorResponse>, sqlx::Error> {
    ...
    Ok(rows
        ...
        .map(|r| AuthorResponse {
            ...
            slug: r.get("slug"),
            bio: r.get("bio"),
            avatar_url: r.get::<Option<String>, _>("avatar_url").map(|u| crate::storage::service::rewrite_gcs_url(&u)),
